<script setup>
import logoImg from '@/assets/campus-forum-logo.svg'
...
<template>
  <div class="main-content" v-loading="loading" element-loading-text="正在进入，请稍候...">
          ...
          <el-scrollbar style="height: calc(100vh - 55px)">
            <router-view v-slot="{ Component }">
              <transition name="el-fade-in-linear" mode="out-in">
                <component :is="Component" style="min-height: calc(100vh - 55px)"/>
              </transition>
            </router-view>
          </el-scrollbar>
        </el-main>
