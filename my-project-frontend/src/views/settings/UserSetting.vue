...
<template>
  <div style="display: flex; max-width: 1000px; margin: 0 auto">
    <div class="setting-left" v-loading="loading.form">
      <card :icon="User" title="账号信息设置" desc="在这编辑您的个信息，您可以在隐私设置中选择是否展示这些信息">
        <el-form :model="baseForm" :rules="rules" ref="baseFormRef" label-position="top" style="margin: 0 10px 10px 10px">
          ...
          <div>
            <el-button type="success" :icon="Select" @click="saveDetails">保存用户信息</el-button>
          </div>
        </el-form>
      </card>
        ...
        <el-form :model="emailForm" :rules="rules" @validate="onValidate" ref="emailFormRef" label-position="top" style="margin: 0 10px 10px 10px">
          ...
          <el-form-item prop="code">
            <el-row style="width: 100%" justify="space-between">
              <el-col :span="17">
                <el-input placeholder="请输入验证码" v-model="emailForm.code"/>
              </el-col>
              <el-col :span="6">
                <el-button type="success" style="width: 100%" plain @click="sendEmailCode" :disabled="!isEmailValid || coldTime > 0">
      ...
      <div style="position: sticky; top: 20px">
        <card>
          <div style="text-align: center; padding: 5px 15px 0 15px">
            ...
            <div style="font-size: 14px; padding: 10px; color: grey;">
